...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amout: @donation.amout, company: @donation.company, date: @donation.date, firstname: @donation.firstname, lastname: @donation.lastname } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amout: @donation.amout, company: @donation.company, date: @donation.date, firstname: @donation.firstname, lastname: @donation.lastname } }
